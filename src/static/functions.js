...
function activate() {
	$("#activate").css("background","-webkit-gradient(linear, left top, left bottom, from(#C9C9C9), to(#69FF69))");
...
function stop() {
	...
	if(str["activated"]=="true") {
		...
		$("#stop").css("background","-webkit-gradient(linear, left top, left bottom, from(#C9C9C9), to(#FF9494))");
